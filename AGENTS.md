...
- **Hosting:** Vercel
- **Auth:** Clerk
- **LLM:** Codex Agent SDK + Anthropic API
...
Siehe: [.Codex/AGENT_ARCHITECTURE.md](.Codex/AGENT_ARCHITECTURE.md)
...
### Skill Registry
- `.Codex/skills/REGISTRY.json` - Alle Skills mit Summary und Token-Schätzung
